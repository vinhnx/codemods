...
compatibility: "Requires Rust project using clap v3"
metadata:
  version: "1.0.8"
allowed-tools: bash str_replace_based_edit_tool glob sequentialthinking task_done
codemod-compatibility: ">=1.0.0"
codemod-skill-version: "1.0.8"
---
