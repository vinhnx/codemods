...
description: Migrate Rust ratatui TUI library across major breaking changes (v0.24–v0.30). Handles Frame::size→area, terminal module privatization, Table renames, Spans→Line, and more. Use this when a Rust project uses ratatui and needs to upgrade to the latest version.
allowed-tools:
  - bash
...
Automates the most common deterministic API renames in the ratatui TUI library migration from v0.24–v0.29 to v0.30.
