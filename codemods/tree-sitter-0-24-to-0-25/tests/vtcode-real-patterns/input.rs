...
impl SymbolExtractor {
    ...
    pub fn find_child_containing<'a>(
        ...
        ancestor.child_containing_descendant(descendant)
    }
    ...
    pub fn find_child_containing_ufcs<'a>(
        ...
        Node::child_containing_descendant(ancestor, descendant)
    }
}
...
pub unsafe fn ffi_find_child(
    ...
    ts_node_child_containing_descendant(parent, descendant)
}
